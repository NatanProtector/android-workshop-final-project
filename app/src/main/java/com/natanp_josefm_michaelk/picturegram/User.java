...
public class User {
    ...
    private String name;
    private String profilePictureUrl; // URL of profile image
    ...
    // Constructor including profile picture URL
    public User(String userId, String name, String profilePictureUrl) {
        this.userId = userId;
        this.name = name;
